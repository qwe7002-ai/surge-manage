...
export const COMMAND_CATALOG: Record<SurgeAction, CommandSpec> = {
  ...
  status: { action: "status", argv: ["status", "--json"], mutates: false, arity: 0 },
  ...
  policies: { action: "policies", argv: ["policy", "list", "--json"], mutates: false, arity: 0 },
  selectPolicy: {
    action: "selectPolicy",
  ...
  rules: { action: "rules", argv: ["rule", "list", "--json"], mutates: false, arity: 0 },
  traffic: { action: "traffic", argv: ["traffic", "--json"], mutates: false, arity: 0 },
